...
s=3 #change the value of s as desired
#For this computation, we're interested in odd s.
...
print(len(non_sums)) #m_s in the paper
print(max(non_sums)) #M_s in the paper